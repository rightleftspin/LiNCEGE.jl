...
# --- Square lattice setup (single-site, order 6) ---
basis_sq = [[0.0, 0.0]]
...
trans_sq = ClusterSet(lattice_sq)
...
# --- Kagome lattice setup (3-site, order 4) ---
...
trans_kag = ClusterSet(lattice_kag)
